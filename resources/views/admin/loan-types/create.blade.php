                    ...
                    <form method="POST" action="{{ route('admin.loan-types.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="calculation_type" name="calculation_type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                <option value="declining_balance" @selected(old('calculation_type') == 'declining_balance')>Declining Balance</option>
                                <option value="flat_interest" @selected(old('calculation_type') == 'flat_interest')>Flat Interest</option>
                                <option value="interest_only" @selected(old('calculation_type') == 'interest_only')>Interest Only</option>
                            </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="min_interest_rate" class="block mt-1 w-full" type="number" name="min_interest_rate" :value="old('min_interest_rate')" required step="0.01" />
                            ...
                            <div>
                                ...
                                <x-text-input id="max_interest_rate" class="block mt-1 w-full" type="number" name="max_interest_rate" :value="old('max_interest_rate')" required step="0.01" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="min_term" class="block mt-1 w-full" type="number" name="min_term" :value="old('min_term')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="max_term" class="block mt-1 w-full" type="number" name="max_term" :value="old('max_term')" required />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                ...
                                <div>
                                    ...
                                    <select id="penalty_type" name="penalty_type" class="block mt-1 w-full ...">
                                        <option value="flat_fee" @selected(old('penalty_type') == 'flat_fee')>Flat Fee</option>
                                        <option value="percentage" @selected(old('penalty_type') == 'percentage')>Percentage of Overdue Amount</option>
                                    </select>
                                </div>
                                <!-- Late Payment Penalty Amount -->
                                <div>
                                    <x-input-label for="penalty_amount" :value="__('Late Payment Penalty Amount ($ or %)')" />
                                    <x-text-input id="penalty_amount" class="block mt-1 w-full" type="number" name="penalty_amount" :value="old('penalty_amount', 0)" required step="0.01" />
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="prepayment_penalty_period" class="block mt-1 w-full" type="number" name="prepayment_penalty_period" :value="old('prepayment_penalty_period')" placeholder="e.g., 12" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="prepayment_penalty_amount" class="block mt-1 w-full" type="number" name="prepayment_penalty_amount" :value="old('prepayment_penalty_amount')" step="0.01" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="grace_days" class="block mt-1 w-full" type="number" name="grace_days" :value="old('grace_days', 0)" required />
