<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 overflow-x-auto overflow-y-hidden">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="relative" x-data="{ open: false, buttonRect: {} }" @click.away="open = false">
                        <button @click="open = !open; buttonRect = $el.getBoundingClientRect()" class="inline-flex items-center px-1 mt-6 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:text-gray-700 dark:focus:text-gray-300 transition duration-150 ease-in-out truncate overflow-hidden">
                            <div>Project Management</div>
                            <div class="ms-1"><svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" /></svg></div>
                        </button>
                        <div x-show="open" 
                            x-transition
                            class="fixed w-48 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-[9999]"
                            :style="`top: ${buttonRect.bottom + 8}px; left: ${buttonRect.left}px;`">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative" x-data="{ open: false, buttonRect: {} }" @click.away="open = false">
                    <button @click="open = !open; buttonRect = $el.getBoundingClientRect()" class="me-2 relative inline-flex items-center p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
                    ...
                    <div x-show="open"
                        x-transition
                        class="fixed w-72 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-[9999]"
                        :style="`top: ${buttonRect.bottom + 8}px; left: ${buttonRect.left}px;`">
                ...
                <!-- Profile Dropdown (modified to match Project Management style) -->
                <div class="relative" x-data="{ open: false, buttonRect: {} }" @click.away="open = false">
                    <button @click="open = !open; buttonRect = $el.getBoundingClientRect()" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150 truncate">
